...
import openCart from './beverageOpenCart';
import closeCart from './beverageCloseCart';
                            ...
                            return (
                                <div key={types.id} className="single-catagory">
                                    ...
                                    <div style={{ margin: "0 auto", padding: "20px", width: "auto", display: "none", transition: "0.5s" }} className={"slider slider" + types.id}>
                                        {
                                            dishes.map(items => {
                                                if (items.catagory === "Beverage" && items.dishType === types.name) {
                                                    return (
